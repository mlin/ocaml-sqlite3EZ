...
(** [transact db f x] evaluates [f db x] within a BEGIN..COMMIT transaction. If [f x] evaluates successfully to [y], the
...
(** [atomically db f x] evaluates [f db x] within a SAVEPOINT..RELEASE transaction, which may be nested.
