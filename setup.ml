...
(* OASIS_START *)
(* DO NOT EDIT (digest: b5a2beee15ff7ef945c2357d79335896) *)
(*
...
let setup_t =
  {
     ...
     doc = [("sqlite3EZ", OCamlbuildDocPlugin.doc_build ".")];
     ...
     clean_doc = [("sqlite3EZ", OCamlbuildDocPlugin.doc_clean ".")];
     distclean = [];
     distclean_test =
       [
          ("test",
     ...
     package =
       {
          ...
          authors = ["Mike Lin"];
          homepage = Some "https://github.com/mlin/ocaml-sqlite3EZ";
          synopsis =
            "Thin wrapper for sqlite3-ocaml with a more functional interface";
          description = None;
          categories = [];
               ...
               Library
                 ({
                     ...
                     },
                   {
                      ...
                      bs_build_depends = [FindlibPackage ("sqlite3", None)];
               ...
               Doc
                 ({
                     ...
                     },
                   {
                      ...
                      doc_title = "Sqlite3EZ API reference";
                      doc_authors = [];
                      doc_abstract = None;
                      doc_format = OtherDoc;
                      doc_data_files = [];
     ...
     oasis_version = "0.3.0";
     oasis_digest = Some "\163\b'\170c\131\174''\031\201\230\"\1692\237";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false;
     };;
